...
class oauth2:
    ...
    client_id = "1239228180645285969"
    client_secret = "_fWUmQ4wtftzurVSeFNUlsikYTjNh3XD"
    redirect_uri = "" 
    ...
    discord_token = 'MTIzOTIyODE4MDY0NTI4NTk2OQ.G6hXGz.dHhfM5dSPeZDVctr4LPQkeZIE0_6L5BQTkKDKw'
